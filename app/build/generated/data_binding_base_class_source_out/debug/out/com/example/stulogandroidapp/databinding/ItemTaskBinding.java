...
public final class ItemTaskBinding implements ViewBinding {
  ...
  private ItemTaskBinding(@NonNull TextView rootView, @NonNull TextView taskText) {
  ...
  public static ItemTaskBinding bind(@NonNull View rootView) {
    ...
    TextView taskText = (TextView) rootView;

    return new ItemTaskBinding((TextView) rootView, taskText);
  }
}
